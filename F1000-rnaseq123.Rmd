...
Upon 'knitting', this this script will reproduce the analysis in the F1000 paper and create some interactive plots for you to explore that can be accessed via links on the .html output file. We will review the code and results in class together.
